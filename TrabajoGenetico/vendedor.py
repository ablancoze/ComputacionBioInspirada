...
class PruebasDeVendedorAmbulante(unittest.TestCase):
    ...
    def test_ulysses16(self):
        búsquedaDeUbicación = cargar_datos("/home/alvaro/Escritorio/UNI/Clase/CompuBioInspirada/workspace/ComputacionBioInspirada/Genetico/ulysses16.tsp")
